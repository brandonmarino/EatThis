"""
Django settings for bitequickadmin project.
...
# load secret keys for fourquare
...
ROOT_URLCONF = 'bitequickadmin.urls'
...
WSGI_APPLICATION = 'bitequickadmin.wsgi.application'
